...
当前示例提供双端共享的 18 个 P0 和 60 个 P1 用例，支持选择、全文、播放、暂停和单步。数据源、覆盖范围及手动验收步骤见 [P0 验收说明](docs/P0.zh-CN.md) 和 [P1 用例与验收](docs/P1.zh-CN.md)。P1 已接入测试入口，尚待执行测试及双端视觉验收，不代表全部语法已通过。
